...
export default function EcommIdeaValidator() {
      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="bg-white rounded-2xl p-8 shadow-lg border border-gray-200 mb-8">
          ...
          <textarea
            ...
            className="w-full h-32 px-4 py-3 bg-gray-50 border border-gray-300 rounded-lg text-gray-900 placeholder-gray-500 focus:outline-none focus:ring-2 focus:ring-purple-500 focus:border-transparent resize-none"
          />
          ...
          <div className="flex flex-wrap gap-2 mt-4 mb-6">
            ...
            {exampleIdeas.map((example, idx) => (
              <button
                ...
                className="text-sm px-3 py-1 bg-gray-100 hover:bg-gray-200 border border-gray-300 rounded-full transition-all text-gray-700"
              >
                {example}
              </button>
            ))}
          ...
          <button
            ...
            disabled={loading}
            className="w-full py-4 bg-gradient-to-r from-purple-600 to-pink-600 hover:from-purple-700 hover:to-pink-700 text-white rounded-lg font-bold text-lg transition-all transform hover:scale-105 disabled:opacity-50 disabled:cursor-not-allowed disabled:transform-none shadow-lg"
          >
            {loading ? (
